...
public class Const {//sw123456
   ...
   // public static  String  Url = "http://sztripsky.com/lsyTEMP/issue/getlsyJson?STB_mac="+ Tools.getMac();
    ...
    public static String[]  apps = {
            "com.booslink.Wihome_videoplayer3",//高清直播 0
            "com.ktcp.video",//影视 1
            "com.meishi_tv",//美食 2
            "com.boll.edu",//教育 3
            "com.tencent.qqmusictv",//音乐 4
            "com.tencent.karaoketv",//欢唱k歌 5
            "com.zxpad.smarthic.app",//智慧家 6
            "allapp",//所有应用 7
            "com.android.tv.settings",//设置 8
            "com.yunos.tv.defensor"//清理 9
    };
